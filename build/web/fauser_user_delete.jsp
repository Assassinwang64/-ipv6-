...
<div class="admin-content">
    ...
    <form id="f2" action="fauser_user_delete_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    request.setCharacterEncoding("utf-8");
            ...
            rs=stmt.executeQuery("select u_id,u_name,u_father_id from myweb.tb_user");
...
Integer a=10000,b=0;
        %><br>
        <form action="user_lock_op.jsp" id="f2">
        <ul class="dowebok">
<% while(rs.next()){
    Integer faid=rs.getInt("u_father_id");
        if(faid.equals(nowfa_id)){
    %>
