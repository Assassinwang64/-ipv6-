...
<%
    request.setCharacterEncoding("utf-8");
           ...
           Integer nowfa_id=0,now_id=0;
            ...
            rs3=stmt3.executeQuery("select * from myweb.tb_user where u_father_id="+nowfa_id);
        %>  
          ...
          <table class="am-table am-table-bd am-table-striped admin-content-table">
            <thead>
            <tr>
              <th>ID</th><th>用户名</th><th>状态</th><th>创建时间</th><th>创建者</th><th>描述</th>
            </tr>
            </thead>
            <tbody>
                
                <% while(rs3.next()){
            Integer lo=rs3.getInt("u_locked");
            String lock="";
            if(lo.equals(0))lock="正常";
            else lock="锁定";
        %><tr>
<td><%=rs3.getInt("u_id")%></td>
<td><%=rs3.getString("u_name")%></td>
<td><%=lock%>&nbsp;&nbsp;&nbsp;</td>
<td><span class="am-badge am-badge-success"><%=rs3.getString("u_create_time")%></span></td>
<td><%=rs3.getString("u_creator_name")%>&nbsp;&nbsp;</td>
<td><%=rs3.getString("u_description")%></td>
</tr>
    <%
        }
    %>
