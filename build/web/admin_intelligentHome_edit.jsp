  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居编辑</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f1" action="admin_intelligentHome_edit_op.jsp" method="post" name="add" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    request.setCharacterEncoding("utf-8");
        ...
        rs3=stmt3.executeQuery("select * from myweb.tb_intelligent_home");  
        Integer uid=0;
        
    %><p align="center">
    <% while(rs3.next()){
    %>
    <input type="radio" name="radio1"  value="<%=rs3.getInt("IHId")%>" data-labelauty="家居ID：<%=rs3.getInt("IHId")%>&nbsp;名称：<%=rs3.getString("IHName")%>" style="padding-left:500px;" >
    <%  }
%> 
</p><br/>
