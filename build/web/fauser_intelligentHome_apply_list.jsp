...
%>
            ...
            rs=stmt.executeQuery("select * from myweb.tb_user_ih where u_id="+nowuserid);
...
<td>
    <form id="f1" action="fauser_intelligentHome_apply_list_op.jsp" method="post">
                <div class="am-dropdown" data-am-dropdown>
                  ...
                  <select name="operate" id=""> 
                    ...
                    <input readonly type="hidden" name="uid" value="<%=nowuserid%>">
    </form>
              </td>
</tr>
    <%
