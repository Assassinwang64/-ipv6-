      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            ...
            <li><a href="admin_mymap.jsp" class="am-cf"><span class="am-icon-puzzle-piece"></span> 您的位置</a></li>
            <li><a href="admin-gallery.html" class="am-cf"><span class="am-icon-th"></span> 家居相册</a></li>
            <li><a href="admin-log.html" class="am-cf"><span class="am-icon-calendar"></span> 系统日志</a></li>
            <li><a href="admin-404.html" class="am-cf"><span class="am-icon-bug"></span> 修改密码</a></li>
          </ul>
        </li>
        <li class="admin-parent">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="admin-user.html" class="am-cf"><span class="am-icon-check"></span> 添加家居</a></li>
            <li><a href="admin-help.html"><span class="am-icon-check"></span>编辑家居</a></li>
            <li><a href="admin-gallery.html"><span class="am-icon-check"></span> 删除家居</a></li>
            <li><a href="admin-log.html"><span class="am-icon-check"></span> 家居列表</a></li>
          </ul>
        </li>
        <li><a href="admin_log.jsp"><span class="am-icon-table"></span> 登录历史</a></li>
        <li><a href="admin-form.html"><span class="am-icon-pencil-square-o"></span> 我的家庭组</a></li>
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">角色添加</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">
...
%>
 ...
 <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">角色ID / RoleId</label>
              <div class="am-u-sm-9">
                  <%
                      Statement stmt11=null;//语句对象
            ResultSet rs11=null;
            int roleidadd=0;
            Connection conn11=null;
             conn=DriverManager.getConnection("jdbc:mysql://localhost/myweb","jakelan","lzk205445");
        try{
            stmt11=conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);
            System.out.println("数据库链接成功");
        }catch(SQLException e){
            e.printStackTrace();
        }
                      String sql311="select * from myweb.logid where description='role_idadd'";
            rs11=stmt11.executeQuery(sql311);
            if(rs11.next())
            {
            roleidadd=rs11.getInt("number");roleidadd++;
            }
            System.out.println(roleidadd);
                      %>
                <input readonly type="text" id="name" name="roleidadd" placeholder="<%=roleidadd%>">
              </div>
            </div>
