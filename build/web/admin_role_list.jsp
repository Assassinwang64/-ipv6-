...
%>
            ...
            rs=stmt.executeQuery("select * from myweb.tb_role");
        ...
        %>
          ...
          <table class="am-table am-table-bd am-table-striped admin-content-table">
            <thead>
            <tr>
              <th>ID</th><th>角色名</th><th>状态</th><th>创建时间</th><th>创建者</th><th>描述</th>
            </tr>
            </thead>
            <tbody>
                <tr>
...
<td><%=rs.getInt("r_status")%>&nbsp;&nbsp;&nbsp;</td>
<td><span class="am-badge am-badge-success"><%=rs.getString("r_create_time")%></span></td>
<td><%=rs.getString("r_creator")%>&nbsp;&nbsp;</td>
<td><%=rs.getString("r_description")%></td>
</tr>
    <%
        }
    %>
