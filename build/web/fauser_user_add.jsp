  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户添加</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">
...
<%
    request.setCharacterEncoding("utf-8");
        Statement stmt=null,stmt2=null,stmt3=null,stmt4=null,stmt5=null;//语句对象
        ...
        rs5=stmt5.executeQuery("select r_id from myweb.tb_role_user where u_id="+uidd);  
        Integer rid=0;
        if(rs5.next()){
            rid=rs5.getInt("r_id");System.out.println("ddd"+rid);
        }
        String sql2="select * from myweb.tb_resource_role where r_id="+rid;
...
%> 
  ...
  <br/>
     ...
     <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">用户ID / UserId</label>
              <div class="am-u-sm-9">
                  <%
        ...
        try{
            ...
            e.printStackTrace();
                      ...
                      String sql311="select * from myweb.logid where description='user_idadd'";
            rs11=stmt11.executeQuery(sql311);
            if(rs11.next())
            {
            useridadd=rs11.getInt("number");useridadd++;
            }
            System.out.println(useridadd);
                      %>
                <input readonly type="text" id="name" name="roleidadd" placeholder="<%=useridadd%>">
              </div>
            </div>
             <div class="am-form-group">
