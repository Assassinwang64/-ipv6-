  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居申请</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f2" action="fauser_intelligentHome_Application_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    request.setCharacterEncoding("utf-8");
            ...
            rs=stmt.executeQuery("select * from myweb.tb_intelligent_home");
...
<% while(rs.next()){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs.getInt("IHId")%>"  data-labelauty="家居&nbsp;<%=rs.getString("IHName")%>--ID:<%=rs.getInt("IHId")%>&nbsp;"></li>
    <%  }
    %>
        </ul>
</div>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="sub2();" name="Submit" value="申请" class="am-btn am-btn-primary" >点击申请</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
