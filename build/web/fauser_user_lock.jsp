...
<div class="admin-content">
    ...
    <form id="f2" action="fauser_user_lock_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<% while(rs.next()){
    ...
    locked=rs.getInt("u_locked");
        if(faid.equals(nowfa_id)&&locked.equals(0)){
    %>
    ...
    %></ul>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="sub2();" name="Submit" value="锁定" class="am-btn am-btn-primary" >点击锁定</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
