...
%>
        ...
        try{
            ...
            Stmt=conn.prepareStatement("update myweb.tb_intelligent_home set IHName='"+ihname+"'"+" where IHId="+radioid);
            Stmt.executeUpdate(); 
            Stmt=conn.prepareStatement("update myweb.tb_intelligent_home set IHDescription='"+ihdes+"'"+" where IHId="+radioid);
            Stmt.executeUpdate(); 
            //request.setCharacterEncoding("GB2312");
 

            RequestDispatcher dispatcher=request.getRequestDispatcher("admin_intelligentHome_edit.jsp");
