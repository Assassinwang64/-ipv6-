...
<div class="admin-content">
    ...
    <form id="f2" action="admin_intelligentHome_delete_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<% while(rs3.next()){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs3.getInt("IHId")%>" data-labelauty="家居ID：<%=rs3.getInt("IHId")%>&nbsp;名称：<%=rs3.getString("IHName")%>" style="padding-left:500px;" ></li>
