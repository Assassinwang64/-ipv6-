		...
		i = {
			...
			loadingCallBack: function(e, t, r) {
				var i = m.canvas.screen.getWidth(),
					...
					e = e > t ? t: e,
					l = parseInt(e / t * 100) + "%";
				m.canvas.fillStyle(n.canvas.bgColor).fillRect(0, 0, i, s).fillStyle("#00FFFF").fillRect(a, f, parseInt(e / t * o), u).fillStyle("#ffa186").fillText("loading " + r, 5, s - 10).fillText(l, i - m.canvas.measureText(l).width - 5, s - 10),
					i = s = o = u = a = f = l = null
			},
		...
		function(e, t, n, r) {
			return {
				init: function() {
					...
					e.run(function() {
						var t = Date.now();
						e.canvas.fillStyle("#ffa186").fillScreen();
						...
						e.canvas.fillStyle("#ffa186").fillScreen().drawImage("logo", i - 480 >> 1, u).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 555, 480, 7),
						...
						e.canvas.fillStyle("#90EE90").fillScreen().fillStyle("#ffa186").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null, null, "50px 微软雅黑").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, "秒"), 0, u + 340, e.graphics.VCENTER, !1, null, null, "60px 微软雅黑").fillStyle("#000").drawString("最佳:" + a(l.bestTime, "秒"), 0, u + 400, e.graphics.VCENTER, !1, null, null, "30px 微软雅黑"),
