  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">角色删除</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f2" action="role_delete_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
%>
  <%
      request.setCharacterEncoding("utf-8");
            ...
            rs=stmt.executeQuery("select r_id,r_name from myweb.tb_role");
...
<% while(rs.next()){
    %>
    <li><input type="radio" name="roleid"  value="<%=rs.getInt("r_id")%>"  data-labelauty="角色<%=rs.getString("r_name")%>--ID:<%=rs.getInt("r_id")%>&nbsp;"></li>
    <%  }
    %>
</div>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="confirmd();" name="Submit" value="提交" class="am-btn am-btn-primary" >点击删除</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
