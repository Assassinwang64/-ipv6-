...
<%!RequestDispatcher dispatcher;%>
        <%
         ...
         Stmt=conn.prepareStatement("update myweb.tb_user set u_locked=1 where u_id="+radiostr);
         Stmt.executeUpdate(); 
         out.print("<script>alert('该用户已锁定...'); </script>");
         out.print("<script>window.location='fauser_user_lock.jsp' </script>");
         %>
    </body>
</html>
