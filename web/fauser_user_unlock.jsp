  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户删除</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">
    ...
    <form id="f2" action="fauser_user_unlock_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    request.setCharacterEncoding("utf-8");
            ...
            rs=stmt.executeQuery("select u_id,u_name,u_father_id,u_locked from myweb.tb_user");
        ...
        <ul class="dowebok">
<% while(rs.next()){
    Integer faid=rs.getInt("u_father_id");
    locked=rs.getInt("u_locked");
        if(faid.equals(nowfa_id)&&locked.equals(1)){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs.getInt("u_id")%>"  data-labelauty="子用户<%=rs.getString("u_name")%>--ID:<%=rs.getInt("u_id")%>&nbsp;"></li>
    <%  }}
    %></ul>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="sub2();" name="Submit" value="解锁" class="am-btn am-btn-primary" >点击解锁</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
