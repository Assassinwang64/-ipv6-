  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居列表</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">   
      <div class="am-g">
...
%>
        ...
        %>
          ...
          <table class="am-table am-table-bd am-table-striped admin-content-table">
            <thead>
            <tr>
              <th>ID</th><th>名称</th><th>状态</th><th>创建时间</th><th>创建者</th><th>描述</th>
            </tr>
            </thead>
            <tbody>
                <tr>
    ...
    %>
<td><%=rs.getInt("IHId")%></td>
<td><%=rs.getString("IHName")%></td>
<td><%=rs.getInt("IHStatus")%>&nbsp;&nbsp;&nbsp;</td>
<td><span class="am-badge am-badge-success"><%=rs.getString("IHCreateTime")%></span></td>
<td><%=rs.getString("IHCreator")%>&nbsp;&nbsp;</td>
<td><%=rs.getString("IHDescription")%></td>
</tr>
    <%
        }
    %>
