  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居删除</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f2" action="fauser_intelligentHome_delete_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    request.setCharacterEncoding("utf-8");
            ...
            rs2=stmt2.executeQuery("select * from myweb.tb_user where u_name='"+ nowuser+"'");
            int uidd=0;
            if(rs2.next()){
                uidd=rs2.getInt("u_id");
            }
            
            rs=stmt.executeQuery("select * from myweb.tb_user_ih where u_id="+ uidd);
...
<% while(rs.next()){
    int ihid=0;
    ihid=rs.getInt("ih_id");
    rs3=stmt3.executeQuery("select * from myweb.tb_intelligent_home where IHId="+ ihid);
    if(rs3.next()){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs3.getInt("IHId")%>"  data-labelauty="家居&nbsp;<%=rs3.getString("IHName")%>--ID:<%=rs3.getInt("IHId")%>&nbsp;"></li>
    <%  }}
    %>
        </ul>
</div>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="sub2();" name="Submit" value="删除" class="am-btn am-btn-primary" >点击删除</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
