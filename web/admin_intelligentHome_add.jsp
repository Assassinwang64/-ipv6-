  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居添加</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f1" action="admin_intelligentHome_add_op.jsp" method="post" name="add" class="am-form am-form-horizontal">
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-4 am-u-md-push-8"><br/>
    ...
    <%
        ...
        Statement stmt44=null;//语句对象
        Connection conn44=null;//结果集对象
        ResultSet rs44=null;
        conn44=DriverManager.getConnection("jdbc:mysql://localhost/myweb","jakelan","lzk205445");
        try{
            stmt44=conn44.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);

            System.out.println("数据库链接成功");
        }catch(SQLException e){
            e.printStackTrace();
        }
        String sql44="select * from myweb.tb_intelligent_home_resource";
        rs44=stmt44.executeQuery(sql44);
        
    %><p align="center">
        <% while(rs44.next()){
    %>
    <input type="checkbox" name="checkbox1"  value="<%=rs44.getInt("IHRId")%>" data-labelauty="家居权限ID：<%=rs44.getInt("IHRId")%>&nbsp;名称：<%=rs44.getString("IHName")%>">
    <%  }
    %>
  ...
  <br/>
            <div class="am-form-group">
              <label for=user-name" class="am-u-sm-3 am-form-label">家居名 / IHName</label>
              <div class="am-u-sm-9">
                <input type="text" id="name" name="IHName" placeholder="家居名 / IHName">
              </div>
            </div>
  <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">家居ID / IHId</label>
              <div class="am-u-sm-9">
        ...
        try{
            ...
            if(rs.next())
            {
            IHId=rs.getInt("number");
            IHId++;
            }
            System.out.println(IHId);
                      %>
                <input type="text" id="name" name="IHId">
            ...
            <div class="am-form-group">
              <label for="user-intro" class="am-u-sm-3 am-form-label">家居描述 / IHDescription</label>
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="user-intro" name="IHDescription" placeholder="家居描述 / IHDescription"></textarea>
