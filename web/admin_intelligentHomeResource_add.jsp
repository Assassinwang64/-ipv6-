  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居权限添加</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f1" action="admin_intelligentHomeResource_add_op.jsp" method="post" name="add" class="am-form am-form-horizontal">
      <div class="am-g">
  ...
  <br/>
            <div class="am-form-group">
              <label for=user-name" class="am-u-sm-3 am-form-label">家居权限名 / IHRName</label>
              <div class="am-u-sm-9">
                <input type="text" id="name" name="IHRName" placeholder="家居权限名 / IHRName">
              </div>
            </div>
  <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">家居权限ID / IHRId</label>
              <div class="am-u-sm-9">
                  <%
        ...
        try{
            ...
            System.out.println(IHRid);
                      %>
                <input readonly type="text" id="name" name="IHRid" placeholder="<%=IHRid%>">
              </div>
            </div>
<div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">操作状态ID / OpStaId</label>
              <div class="am-u-sm-9">
                  <%
                      request.setCharacterEncoding("utf-8");
                      Statement stmt2=null;//语句对象
            ResultSet rs2=null;
            int opstaid=0;
            Connection conn2=null;
             conn2=DriverManager.getConnection("jdbc:mysql://localhost/myweb","jakelan","lzk205445");
        try{
            ...
            if(rs2.next())
            {
            opstaid=rs2.getInt("number");
            opstaid++;
            }
            System.out.println(opstaid);
                      %>
                <input readonly type="text" id="name" name="opstaid" placeholder="<%=opstaid%>">
              </div>
            </div>


            <div class="am-form-group">
              <label for="user-intro" class="am-u-sm-3 am-form-label">家居权限描述 / IHRDescription</label>
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="user-intro" name="IHRDescription" placeholder="家居权限描述 / IHRDescription"></textarea>
