  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户解锁</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">
    ...
    <form id="f2" action="user_unlock_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<% while(rs.next()){
    locked=rs.getInt("u_locked");
        if(locked.equals(1)){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs.getInt("u_id")%>"  data-labelauty="用户<%=rs.getString("u_name")%>--ID:<%=rs.getInt("u_id")%>&nbsp;"></li>
    <%  }}
    %>
