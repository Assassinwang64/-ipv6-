  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">家居权限编辑</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">

      <hr/>
    <form id="f1" action="admin_intelligentHomeResource_edit_op.jsp" method="post" name="add" class="am-form am-form-horizontal">
      <div class="am-g">
...
<%
    ...
    <% while(rs3.next()){
    %>
    <input type="radio" name="radio1"  value="<%=rs3.getInt("IHRId")%>" data-labelauty="权限ID：<%=rs3.getInt("IHRId")%>&nbsp;名称：<%=rs3.getString("IHName")%>" style="padding-left:500px;" >
    <%  }
%> 
</p><br/>
