  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">角色锁定</strong> / <small>模块</small></div>
      </div>
<div class="admin-content">
    <div class="admin-content-body">
    ...
    <form id="f1" action="role_lock_op.jsp" method="post" name="delete" class="am-form am-form-horizontal">
      <div class="am-g">
...
<% while(rs.next()){
    Integer rsta=rs.getInt("r_status");
        if(rsta==1){
    %>
    <li><input type="radio" name="radio1"  value="<%=rs.getInt("r_id")%>"  data-labelauty="<%=rs.getString("r_name")%>--ID:<%=rs.getInt("r_id")%>--未锁"></li>
    <%  }}
    %>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3" style="padding-left:270px;">
                <button type="button" onclick="sub();" name="Submit" value="锁定" class="am-btn am-btn-primary" >点击锁定</button><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              </div>
            </div>
        </div>
      </div>
