...
<%!RequestDispatcher dispatcher;%>
        <%
         ...
         Stmt=conn.prepareStatement("update myweb.tb_user set u_locked=0 where u_id="+radiostr);
         Stmt.executeUpdate(); 
         out.print("<script>alert('该用户已解锁...'); </script>");
         out.print("<script>window.location='fauser_user_unlock.jsp' </script>");
         %>
    </body>
</html>
